...
moved to https://github.com/qouteall/RustWasmMultithreadingHotswapExample (it requires unstable toolchain, mixing toolchains in one repo may cause some issues)
